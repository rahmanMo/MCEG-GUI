...
scheduler.add_job(STG1D0_job, 'interval', seconds=40)
scheduler.add_job(STG1D1_job, 'interval', seconds=40)
scheduler.add_job(STG1D2_job, 'interval', seconds=40)
scheduler.add_job(STG1D3_job, 'interval', seconds=40)
scheduler.add_job(STG1D4_job, 'interval', seconds=40)
scheduler.add_job(STG1D5_job, 'interval', seconds=40)
scheduler.add_job(STG1D6_job, 'interval', seconds=40)
scheduler.add_job(STG1D7_job, 'interval', seconds=40)
scheduler.start()
